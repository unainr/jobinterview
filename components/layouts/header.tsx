									...
									<li key={index}>
										<Link
											...
											className={cn(
												...
												isActive(item.href)
													? "text-[#c8d92e]  after:absolute after:bottom-0 after:left-3.5 after:right-3.5 after:h-0.5 after:rounded-t after:bg-[#c8d92e]"
										...
										<li key={index}>
											<Link
												...
												className={cn(
													...
													isActive(item.href) &&
														"text-blue-400 hover:text-blue-600 underline underline-offset-4  font-semibold",
												)}>
												<span>{item.name}</span>
											</Link>
										</li>
